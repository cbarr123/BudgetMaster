...
namespace BudgetMaster.Controllers
{
    ...
    public class ExpenseCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ExpenseCategoryId,Label")] ExpenseCategory expenseCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExpenseCategoryId,Label")] ExpenseCategory expenseCategory)
        {
